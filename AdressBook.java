...
public class AdressBook extends Contact {
	    ...
	    public void showContact(AdressBook contact){
	    ...
	    public void editContact(AdressBook[] contactArr){
	    ...
	    public void deleteContact(AdressBook[] contactArr){
	        ...
	        for(int i=0; i<contactArr.length; i++){
	            if(editName.equals(contactArr[i].getFirstName())){
	                AdressBook detail = new AdressBook();
	                contactArr[i] = detail;
	                flag = 0;
	            }
	        }
